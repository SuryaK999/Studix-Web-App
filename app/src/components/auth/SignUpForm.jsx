        ...
        {error && (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              <Label htmlFor="displayName" className="text-[12px] font-semibold text-white/70">Full Name</Label>
              <div className="relative group">
                <User className={`absolute left-3.5 top-1/2 -translate-y-1/2 h-[16px] w-[16px] transition-colors group-focus-within:text-purple-400 ${displayName.length > 0 ? 'text-purple-400' : 'text-white/50'}`} />
                <Input
                  id="displayName"
                  type="text"
            ...
            <div className="space-y-1.5">
              <Label htmlFor="password" className="text-[12px] font-semibold text-white/70">Password</Label>
              <div className="relative group">
                <Lock className={`absolute left-3.5 top-1/2 -translate-y-1/2 h-[16px] w-[16px] transition-colors group-focus-within:text-purple-400 ${password.length > 0 ? 'text-purple-400' : 'text-white/50'}`} />
                <Input
                  id="password"
                  type="password"
